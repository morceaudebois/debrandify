		...
		<tr>
			...
			<td>
				<label class='switch'>
					...
					<input name="dbrdify_<?php echo $key; ?>" <?php echo $isChecked ?> type="hidden" value="no">
					<input id="<?php echo $key ?>" name="dbrdify_<?php echo $key; ?>" <?php echo $isChecked ?>type="checkbox" value="yes">
